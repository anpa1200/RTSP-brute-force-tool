...
```bash
git clone https://github.com/anpa1200/RTSP-brute-force-tool.git
...
## Guides and Kali Linux Submission

- [Complete RTSP security assessment guide](https://medium.com/@1200km/cracking-rtsp-security-a-comprehensive-guide-to-using-the-rtsp-brute-force-tool-ad1c29b9e5ee)
- [1200km PT Tools and Techniques](https://1200km.com/pt-tools.html)
- [Kali Linux New Tool Request draft](docs/kali-new-tool-request.md)
